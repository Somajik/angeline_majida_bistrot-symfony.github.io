 ...
 */
class getCommandeLigneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommandeLigneRepository' shared autowired service.
     *
     * @return \App\Repository\CommandeLigneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommandeLigneRepository.php';

        return $container->privates['App\\Repository\\CommandeLigneRepository'] = new \App\Repository\CommandeLigneRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
