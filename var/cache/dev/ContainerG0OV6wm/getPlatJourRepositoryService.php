 ...
 */
class getPlatJourRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlatJourRepository' shared autowired service.
     *
     * @return \App\Repository\PlatJourRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlatJourRepository.php';

        return $container->privates['App\\Repository\\PlatJourRepository'] = new \App\Repository\PlatJourRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
