 ...
 */
class getCommandeAEmporterRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommandeAEmporterRepository' shared autowired service.
     *
     * @return \App\Repository\CommandeAEmporterRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommandeAEmporterRepository.php';

        return $container->privates['App\\Repository\\CommandeAEmporterRepository'] = new \App\Repository\CommandeAEmporterRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
