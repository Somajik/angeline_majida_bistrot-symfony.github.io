 ...
 */
class getAdminReservationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdminReservationRepository' shared autowired service.
     *
     * @return \App\Repository\AdminReservationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdminReservationRepository.php';

        return $container->privates['App\\Repository\\AdminReservationRepository'] = new \App\Repository\AdminReservationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
