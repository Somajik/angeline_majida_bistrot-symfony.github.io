...
class __TwigTemplate_0d27ac6b1e7c751ea4cd3bcc9d0a2b1625e15f9a9388d283b79211baf1980009 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/enregistrer_icon.png"), "html", null, true);
        echo "\" alt=\"Enregistrer\" class=\"icon\"></a>    
";
        // line 5
...
";
    ...
    <button class=\"icon\"><img src=\"{{ asset('images/enregistrer_icon.png') }}\" alt=\"Enregistrer\" class=\"icon\"></a>    
{{ form_end(form) }}
", "user/_form.html.twig", "C:\\xampp\\htdocs\\angeline_majida_bistrot-symfony\\templates\\user\\_form.html.twig");
    }
}
