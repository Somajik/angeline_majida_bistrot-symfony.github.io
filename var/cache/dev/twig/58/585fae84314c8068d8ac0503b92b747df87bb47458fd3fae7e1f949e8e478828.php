...
/* user/edit.html.twig */
class __TwigTemplate_d17297018545b455b008c35ae14faf46bb23ab9d1a77ede6825954555a697be6 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo " ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 6, $this->source); })()), "user", [], "any", false, false, false, 6), "firstname", [], "any", false, false, false, 6), "html", null, true);
        echo "</h1>
    ...
    {
        return array (  101 => 10,  96 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Edition d'un profil{% endblock %}

{% block body %}
    <h1>Editer le profil de {{ app.user.name|capitalize }} {{ app.user.firstname }}</h1>

    {{ include('user/_form.html.twig', {'button_label': 'Update'}) }}

    <a href=\"{{ path('app_user_index') }}\"><img src=\"{{ asset('images/retour_icon.png') }}\" alt=\"Retour à la liste\" class=\"icon\"></a>

    {# {{ include('user/admin/_delete_form.html.twig') }} #}
{% endblock %}
", "user/edit.html.twig", "C:\\xampp\\htdocs\\angeline_majida_bistrot-symfony\\templates\\user\\edit.html.twig");
    }
}
