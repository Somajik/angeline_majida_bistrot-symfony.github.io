...
class __TwigTemplate_9a94c36c11ab779e1c0e0d802a81c3c104e58af82721e9fc2faf4da93f5d487b extends Template
{
    private $source;
    private $macros = [];
    ...
    <table>
        ...
        <tr>Îcone : <img src=\"";
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 10, $this->source); })()), "request", [], "any", false, false, false, 10), "basepath", [], "any", false, false, false, 10), "html", null, true);
        echo "/images/";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 10, $this->source); })()), "image", [], "any", false, false, false, 10), "html", null, true);
        echo "\" alt=\"";
...
";
    ...
    {
        return array (  123 => 17,  116 => 15,  109 => 13,  99 => 10,  95 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <table>
        <tr>Id : {{ category.id }} <br/></tr>
        <tr>Îcone : <img src=\"{{app.request.basepath}}/images/{{ category.image }}\" alt=\"{{ category.name }}\" class =\"icon\"></tr>
    </table>

    <a href=\"{{ path('app_category_index') }}\"><img src=\"{{ asset('images/retour_icon.png') }}\" alt=\"Retour à la liste\" class=\"icon\"></a>

    <a href=\"{{ path('app_category_edit', {'id': category.id}) }}\"><img src=\"{{ asset('images/edit_icon.png') }}\" alt=\"Modifier\" class=\"icon\"></a>

    {{ include('category/_delete_form.html.twig') }}
{% endblock %}
", "category/show.html.twig", "C:\\xampp\\htdocs\\angeline_majida_bistrot-symfony\\templates\\category\\show.html.twig");
    }
}
